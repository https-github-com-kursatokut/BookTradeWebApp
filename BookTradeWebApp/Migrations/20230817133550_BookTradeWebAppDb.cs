...
{
    /// <inheritdoc />
    public partial class BookTradeWebAppDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TradeOfferId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    OfferingUserId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TradeOffers_Books_OfferedBookId",
                        column: x => x.OfferedBookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TradeOffers_Books_TargetBookId",
                        column: x => x.TargetBookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TradeOffers_Users_OfferingUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TradeOffers_OfferedBookId",
                table: "TradeOffers",
                column: "OfferedBookId");

            migrationBuilder.CreateIndex(
                name: "IX_TradeOffers_OfferingUserId",
                table: "TradeOffers",
                column: "OfferingUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TradeOffers_TargetBookId",
                table: "TradeOffers",
                column: "TargetBookId");
        }
